...
def get_config():
    ...
    parser.add_argument('--alternative_model_family_name', type=str, default="",
                        help="Only to be used for the final round, when using the initial model")
...
def main():
    ...
    debug_loader = get_idefics_loader(cfg, "val", eval_mode, "standard", precompute_analysis=True)
    ...
    savename = "analysis_preds"
    if cfg["file_suffix"] != "":
        savename = savename + cfg["file_suffix"]
